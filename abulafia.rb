...
george_message = StateMachine.new(:george_message, "I strolled into the house. As soon as I got in the door, I saw this handwritten note from George Cobb. Turns out Daniel Santiago had been exterminated. The departed’s flask stopped the first bullet—but not the second, or third. Attached to the handwritten note was a torn newspaper article from the morning paper. Its headline: '#{noun} To Close Down Due To Gang Violence.' Was there any connection? I dusted off my jacket, lit up my last cigar, grabbed my hat and walked out. “I need a promotion,” I snarled, grabbing my piece.",
{
