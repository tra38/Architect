...
skyscraperdeath = StateMachine.new(:skyscraperdeath, "I stopped off at the skyscraper and ordered the best burger the city has to offer, when in walks Investigator Blake—looking for me, as usual. Turned out George Cobb managed to get himself wasted. Looks like our late lamented unfortunate soul got worked over by a lead pipe. Autopsy results showed up late yesterday. “Dammit,” I growled.",{
  :date_gone_wrong => "Miss Kitty Baker just smiled at me and left my office. She said that I would receive her message at the skyscraper. Confused, I decided to walk into the tiger's maw...to the cursed skyscraper itself. If it was a trap, I would be ready for it.",
  :origin_story => "Before his untimely death, Bobby Jackson met with George Cobb at the skyscraper. I decided to walk over to the skyscraper myself, to see if I can maybe interrogate George and learn more information about Bobby's murderers.",
  :babysitting => "But, as much as I hate to admit it, Simpson may have had a point. So I walked over to the skyscraper, hoping to see any suspicious behavior by the staff that could suggest shady activities.",
  :major_breakthrough => "The G-Men supposedly hang out at the skyscraper itself, monitoring any suspicious people that they wish to kill. I took this as a cue to go to the cursed skyscraper myself, to hopefully catch a glimpse of these vigilantes in action.",
  :george_message => "I need to meet George Cobb in person to learn more. I knew George had always loved seeing the skyscraper, so I decided to visit the cursed building myself."
  })

date_gone_wrong = StateMachine.new(:date_gone_wrong, "Miss Kitty Rider prowled through my door like a tigress slinks into a Burmese orphanage—a pinup blonde with legs as far as you could want ’em. No dame her age could afford a coat like that, my money was right where my mind was: the gutter. She was to bad news what apple pie is to America. The dame was all business—before I could even close the office door, she told me she wants Investigator Blake dead. Turns out Blake is masterminding the gang violence, and wants to seize the skyscraper for himself by killing off all his rivals. I laughed at her; Blake may be a devil, but he's a devil I can work with. I wasn't going to sell him out.",
{
  ...
  :major_breakthrough => "I knew that the rogue G-Men answered to a dame named Miss Kitty Rider. So I called her up and asked her to come to my office for a little 'meeting of the minds'. I arrived to my office, and made sure my gun was loaded.",
...
george_message = StateMachine.new(:george_message, "I strolled into the house. As soon as I got in the door, I saw this handwritten note from George Cobb. Turns out Daniel Santiago had been exterminated. The departed’s flask stopped the first bullet—but not the second, or third. I couldn’t help but remember the morning paper’s headline: 'Skyscraper To Close Down Due To Gang Violence.' Was there any connection? Heard from the lab early this morning. I dusted off my jacket, lit up my last cigar, grabbed my hat and walked out. “I need a promotion,” I snarled, grabbing my piece.",
{
  ...
  :babysitting => "If I was to solve this case on my own, I needed to get a lot of data quickly. I knew that George Cobb had kept numerous records about every murder in the city connected to the skyscraper. George would probably not even notice if I decided to 'borrow' some of his notes.",
  ...
  :major_breakthrough => "It seemed that these rogue G-Men had a relationship with George Cobb, and gave Cobb numerous records about every murder in the city connected to the skyscraper. George would probably not even notice if I decided to 'borrow' some of his notes."
  })
...
babysitting = StateMachine.new(:babysitting, "“An inside job…?” Simpson gasped timidly. “Well … No… not an inside job,” I growled. I could barely contain myself with this new guy. “Here’s the deal,” I muttered, “Why don’t I handle this case, while you make like a magnet … and flux off?” ",{
  :skyscraperdeath => "I pleaded Investigator Blake for assistance; this conspiracy is way too much for one man to tackle. Investigator Blake heard my pleas...and suggested that I would get a fresh recruit from the police academy who is 'on the ball'. Mr. Simpson.",
  ...
  :origin_story => "Before his death, Bobby Jackson had hired a fresh recruit from the police academy who was 'on the ball'. Bobby wanted to use this recruit to  I decided to meet up with Mr. Simpson, foolishly thinking that he could be a valuable partner.",
...
origin_story = StateMachine.new(:origin_story,"This case was a real tough one: A skyscraper, towering over the downtown skyline, an attractive tourist attraction for the elite and powerful. Every vulture capitalist wanted to own a piece of nostalgia, and all of them were willing to pay the ultimate price. The latest victim? Bobby Jackson. Seems there was a struggle … and our late lamented poor slob was strangled to death. Allegedly, the deed was done within the past 24 hours. “Must be another inside job,” I mumbled to no one in particular.", {
  ...
  :date_gone_wrong => "Miss Kitty Rider then gave a sob story about how her brother, Bobby Jackson, was murdered as part of the gang wars over the skyscraper. I told her that I might 'consider' her request to kill Investigator Blake if she led me to Bobby's dead body. She agreed to my request.",
  :george_message => "I continued reading the note. George Cobb mentioned that he interviewed Bobby Jackson, a wealthy investor with direct ties to the skyscraper, to find out more information about the death of Daniel Santiago. I decided to pay a visit to Bobby's house...but only found Bobby's dead body instead. Just my luck.",
  :babysitting => "I needed a new partner. Someone who actually had a brain. In the past, George Cobb recommended Bobby Jackson, a wealthy investor with direct ties to the skyscraper, as a possible resource for me to use. I decided to pay a visit to Bobby's house...but only found Bobby's dead body instead. Just my luck.",
...
major_breakthrough = StateMachine.new(:major_breakthrough,"I had little to go on this time … but the office did manage to dig something up. G-Men, fighting crime and resisting corruption, deciding that the best way to fight crime and resist corruption is to kill everyone who might be a criminal and might be corrupt. Their current goal is to 'purify' the skyscraper before moving onto other tourist attractions. I always knew that G-Men were a little 'special'.",
{
